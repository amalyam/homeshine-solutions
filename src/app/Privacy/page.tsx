      ...
      >
        <Container sx={{ backgroundColor: "white", margin: 8, padding: 4 }}>
          ...
          <div data-custom-class="body">
            ...
            <div style={{ lineHeight: "1.5", marginTop: 15 }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    HomeShine Solutions, LLC. is committed to protecting and
                    respecting your privacy. This privacy notice for HomeShine
                    Solutions, LLC. (sometimes doing business as "HomeShine") ("
                ...
                <span style={{ fontSize: 15 }}>
                  <span style={{ color: "rgb(127, 127, 127)" }}>
                    <span data-custom-class="body_text">
                      ...
                      rights and choices. Please read this policy carefully to
                      understand how we handle and treat your personal
              ...
              <div style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    ...
                    easiest way to exercise your rights is by visiting email
                    homeshinellc@gmail.com , or by contacting us. We will
