            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <dt className="question">September 12, 2023</dt>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                This privacy notice for HomeShine Solutions, LLC. (doing
                business as HomeShine) ("<strong>we</strong>," "
                <strong>us</strong>," or "<strong>our</strong>"
              </span>
              <span data-custom-class="body_text">
                ), describes how and why we might collect, store, use, and/or
                share (<dt className="block-component" />"
                <strong>process</strong>"
                <dt className="statement-end-if-in-editor" />) your information
                when you use our services (<dt className="block-component" />"
          ...
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  Visit our website
                  <dt className="block-component" /> at{" "}
                  <dt className="question">
                    <a
                      href="http://www.homeshinesolutions.com"
                      target="_blank"
                      data-custom-class="link"
                    >
                      http://www.homeshinesolutions.com
                    </a>
                  </dt>
                  <span style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(89, 89, 89)" }}>
            ...
            <span style={{ fontSize: 15 }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  <dt className="question">homeshinesolutionsllc@gmail.com</dt>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                specific <dt className="block-component" />
          ...
          <div style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <dt className="block-component" />
                visiting{" "}
                <dt className="question">email homeshinellc@gmail.com</dt>
                <dt className="else-block" />, or by contacting us. We will
            ...
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      <dt className="forloop-component" />
                    </span>
                  </span>
                </span>
              </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        <dt className="question">names</dt>
                      </span>
                    </span>
                  </span>
                </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        <dt className="question">phone numbers</dt>
                      </span>
                    </span>
                  </span>
                </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        <dt className="question">email addresses</dt>
                      </span>
                    </span>
                  </span>
                </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        <dt className="question">mailing addresses</dt>
                      </span>
                    </span>
                  </span>
                </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        <dt className="question">contact preferences</dt>
                      </span>
                    </span>
                  </span>
                </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        <dt className="question">service interests</dt>
                      </span>
                    </span>
                  </span>
                </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        <dt className="question">referral sources</dt>
                      </span>
                    </span>
                  </span>
                </span>
                                        ...
                                        <li style={{ lineHeight: "1.5" }}>
                                          <span data-custom-class="body_text">
                                            <span style={{ fontSize: 15 }}>
                                              ...
                                              identify usage trends, determine
                                                                ...
                                                                <span data-custom-class="body_text">
                                                                  ...
                                                                  >
                                                                    <span data-custom-class="body_text">
                                                                      <dt className="block-component" />
                                                                      <dt className="question">
                                                                        michael.homeshinesolutions@gmail.com
                                                                      </dt>
                                                                      <dt className="else-block" />
                                                                    </span>
                                                                  </span>
